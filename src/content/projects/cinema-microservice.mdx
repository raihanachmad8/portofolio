...
role: "Backend developer — service design, API implementation, infrastructure integration."
...
|---|---|---|
| Framework | .NET Core 8 (C#) | Backend services |
...
| Gateway | Ocelot | API routing and aggregation |
