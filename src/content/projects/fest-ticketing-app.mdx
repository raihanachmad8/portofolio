...
role: "Backend Integration — API integration, image pipeline, testing."
...
| Camera | Flutter Camera Plugin | Image capture |
| Network | HTTP Client | API communication |
| Backend | FastAPI (external) | Face recognition processing |
