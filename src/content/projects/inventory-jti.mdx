...
role: "Lead Developer — fullstack architecture, native MVC, autoloader, PHP lifecycle, database abstraction."
...
images:
  - "/images/projects/inventory-jti/dashboard.png"
  - "/images/projects/inventory-jti/database.png"
  - "/images/projects/inventory-jti/screenshot.png"
  - "/images/projects/inventory-jti/system-design.png"
order: 1
---
...
|---|---|---|
| Autoloader | Native PHP | Class loading like Composer |
| Routing | Custom Router | URL mapping without framework |
| MVC | Native PHP (OOP) | Controllers, Models, Views |
| Database | MySQL via PDO | Prepared Statements, SQL Injection prevention |
| Frontend | Bootstrap, jQuery | Responsive UI |
