...
const DATABASES = {
  projects: import.meta.env.NOTION_DB_PROJECTS,
  skills: import.meta.env.NOTION_DB_SKILLS,
  experience: import.meta.env.NOTION_DB_EXPERIENCE,
  blog: import.meta.env.NOTION_DB_BLOG,
  settings: import.meta.env.NOTION_DB_SETTINGS,
};
